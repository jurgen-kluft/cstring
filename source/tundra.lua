...
Build {
	...
	Units = function ()
		...
		local xstring_library = StaticLibrary {
			Name = "xstring",
			Config = "*-*-*-*",
			Sources = { SourceGlob("source/main/cpp") },
			Includes = { "../xstring/source/main/include","../xbase/source/main/include","../xunittest/source/main/include" },
		}
		...
		local unittest = Program {
			...
			Includes = { "source/main/include","source/test/include","../xunittest/source/main/include","../xentry/source/main/include","../xbase/source/main/include","../xstring/source/main/include" },
			Depends = { xbase_library,xstring_library,xunittest_library },
		}
		Default(unittest)
	end,
	Configs = {
